...
if residual_bolus:
    grid, settings = joblib.load(
        "/rl/dir/pid_ma_tune_experiment_name_final_itr/grid_and_settings.pkl"
    )
else:
    grid, settings = joblib.load(
        "/rl/dir/pid_tune_experiment_name_final_itr/grid_and_settings.pkl"
    )
...
for tstd in tstd_options:
    for person in person_options:
        ...
        joblib.dump(
            res_arr, "{}/{}_simulation_tstd{}.pkl".format(save_dir, person, tstd)
        )
